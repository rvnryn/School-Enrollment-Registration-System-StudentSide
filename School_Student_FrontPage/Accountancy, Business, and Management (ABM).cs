...
{
    public partial class Accountancy__Business__and_Management__ABM_ : Form
    {
        private bool isImageToggled;
        public Accountancy__Business__and_Management__ABM_()
        {
            InitializeComponent();
        ...
        private void Accountancy__Business__and_Management__ABM__Load(object sender, EventArgs e)
        {
